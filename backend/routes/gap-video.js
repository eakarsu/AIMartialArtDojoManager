...
// Route: /api/gap-video
// Feature: Video
// Description: Video submission system (student technique for feedback)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Video. Video submission system (student technique for feedback)' },
